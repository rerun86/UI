...
local Library = {
    ...
    FontColor = Color3.fromRGB(225, 114, 44);
    MainColor = Color3.fromRGB(24, 26, 47);
    BackgroundColor = Color3.fromRGB(24, 26, 47);
    AccentColor = Color3.fromRGB(255, 91, 0);
    OutlineColor = Color3.fromRGB(24, 21, 19);
